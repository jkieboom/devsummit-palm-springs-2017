...
declare namespace __esri {
  ...
  export interface StreamControllerFilter {
    geometry: Extent;
    where: string;
  }

  export interface StreamControllerUpdateFilterFilterChanges {
    geometry: Extent;
    where: string;
  }
  ...
  interface StreamController extends Accessor, corePromise, Evented {
    filter: StreamControllerFilter;
    graphics: Collection;

    connect(): void;
    disconnect(): void;
    updateFilter(filterChanges: StreamControllerUpdateFilterFilterChanges): IPromise<any>;
  }

  interface StreamControllerConstructor {
    new(properties?: StreamControllerProperties): StreamController;
  }

  export const StreamController: StreamControllerConstructor;

  interface StreamControllerProperties {
    filter?: StreamControllerFilter;
    graphics?: Collection;
  }
  ...
  interface Search extends Accessor, Widgette, Evented {
  ...
  interface SearchProperties extends WidgetteProperties {
    activeSource?: FeatureLayer | Locator;
    activeSourceIndex?: number;
    allPlaceholder?: string;
    autoSelect?: boolean;
...
declare module "esri" {
  ...
  export import StreamControllerFilter = __esri.StreamControllerFilter;

  export import StreamControllerUpdateFilterFilterChanges = __esri.StreamControllerUpdateFilterFilterChanges;
...
declare module "esri/layers/graphics/controllers/StreamController" {
  import StreamController = __esri.StreamController;
