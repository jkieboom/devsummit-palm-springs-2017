...
import { mat4, mat3, vec3 } from "https://cdnjs.cloudflare.com/ajax/libs/gl-matrix/2.3.2/gl-matrix-min.js";
...
class CustomRenderer {
  ...
  render(context: esri.RenderContext) {
    ...
    for (const object of this.objects) {
      const viewMatrix = mat4.translate(new Array(16) as any, camera.viewMatrix, object.origin);
  ...
  add(point: esri.Point) {
    ...
    this.objects.push({
      origin,
      modelMatrix,
      normalMatrix: mat3.normalFromMat4(new Array(9) as any, modelMatrix as any) as any
    });
